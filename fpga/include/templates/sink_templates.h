...
#define SINK_KERNEL_uchar_(UNROLL, IN_CHANNEL) __kernel \
...
#define SINK_KERNEL_uchar_1(UNROLL, IN_CHANNEL) __kernel \
void kernel_sink( __attribute__((intel_host_accessible, blocking)) __write_only pipe ulong4 device_out,\
                       uint items) {\
  uchar16 in_vector[2];\
  ulong4 out_data;\
...
#define SINK_KERNEL_uchar_16(UNROLL, IN_CHANNEL) __kernel \
void kernel_sink( __attribute__((intel_host_accessible, blocking)) __write_only pipe ulong4 device_out,\
                       uint items) {\
  uchar16 in_vector[2];\
  ulong4 out_data;\
...
#define SINK_KERNEL_uchar_32(UNROLL, IN_CHANNEL) __kernel \
void kernel_sink( __attribute__((intel_host_accessible, blocking)) __write_only pipe ulong4 device_out,\
                       uint items) {\
...
// #define SINK_KERNEL_UCHAR_32(IN_CHANNEL0, IN_CHANNEL1) __kernel                         \
// void kernel_sink(                                                                       \
...
#define SINK_KERNEL_short_(UNROLL, IN_CHANNEL) __kernel \
void kernel_sink( __attribute__((intel_host_accessible, blocking)) __write_only pipe ulong4 device_out,\
                       uint items) {\
  uint8 in_vector;\
  ulong4 out_data;\
...
#define SINK_KERNEL_uint_(UNROLL, IN_CHANNEL) __kernel \
void kernel_sink( __attribute__((intel_host_accessible, blocking)) __write_only pipe ulong4 device_out,\
                       uint items) {\
  uint8 in_vector;\
  ulong4 out_data;\
...
#define SINK_KERNEL_uint_1(UNROLL, IN_CHANNEL) __kernel \
void kernel_sink( __attribute__((intel_host_accessible, blocking)) __write_only pipe ulong4 device_out,\
                       uint items) {\
  uint8 in_vector;\
  ulong4 out_data;\
...
#define HOLE(NAME, TYPE, SIMD_SIZE, IN_CHANNEL)\
 __attribute__((max_global_work_dim(0)))                                       \
 __attribute__((autorun)) __kernel                                             \
void NAME() {\
  while (1) {\
    read_channel_intel(IN_CHANNEL);\
  }\
}